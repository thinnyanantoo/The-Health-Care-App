...
object SessionManager {
    ...
    var con_id: String?
        get() = preferences.getString(sharePreferenceConID, "")
        set(value) = preferences.edit {
            it.putString(sharePreferenceConID, value)
        }
    ...
    var speciality_id: String?
        get() = preferences.getString(sharePreferenceSpecialityID, "")
        set(value) = preferences.edit {
            it.putString(sharePreferenceSpecialityID, value)
        }
